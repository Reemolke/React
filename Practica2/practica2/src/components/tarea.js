...
function Tarea({tarea,completada,index,eliminarTarea,completarTarea}){
    return (
        <div class="listaTexto">
            <div class="texto"><span>{tarea}</span><span>{completada && (<img class="checked" src="https://static.vecteezy.com/system/resources/previews/010/152/436/original/tick-check-mark-icon-sign-symbol-design-free-png.png" alt="check"></img>)}
