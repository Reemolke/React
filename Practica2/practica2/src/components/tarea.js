...
function Tarea({tarea,completada,index,eliminarTarea,completarTarea}){
    return (
        <div class="listaTexto">
            <div class="texto"><span>{tarea}{completada && (<img class="checked" src="https://d1nhio0ox7pgb.cloudfront.net/_img/v_collection_png/32x32/shadow/check.png" alt="check"></img>)}
